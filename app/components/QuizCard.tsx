...
//                                 }
//                 ${selectedAnswer && option.isCorrect && ' bg-opacity-20 border-green-500'}
//               `}
//                         >
//                             {option.text}
//                         </button>
...
//                                         : 'hover:border-blue-500 hover:bg-gray-100'
//                                     }
//                                     ${selectedAnswer && option.isCorrect && 'border-green-500'}
//                                 `}
//                             >
//                                 {option.text}
//                             </button>

//                             {/* Cross Icon (Only for incorrect selected answers) */}
//                             {isWrong && (
                        ...
                        <div key={option.text} className="relative">
                            <button
                                ...
                                className={`
                                    ...
                                    ${isSelected
                                        ? option.isCorrect
                                            ? 'border-green-500 font-bold' // Green border for correct
                                            : 'border-red-500 bg-red-100' // Red border for incorrect
                                        : isCorrect && selectedAnswer
                                            ? 'border-green-500 font-bold' // Keep correct answer green even if wrong answer is selected
                                            : isDisabled
